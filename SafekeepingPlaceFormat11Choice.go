...
func (s *SafekeepingPlaceFormat11Choice) AddIdentification() *SafekeepingPlaceTypeAndText9 {
	s.Identification = new(SafekeepingPlaceTypeAndText9)
	return s.Identification
}

func (s *SafekeepingPlaceFormat11Choice) SetCountry(value string) {
	s.Country = (*CountryCode)(&value)
}

func (s *SafekeepingPlaceFormat11Choice) AddTypeAndIdentification() *SafekeepingPlaceTypeAndAnyBICIdentifier1 {
	s.TypeAndIdentification = new(SafekeepingPlaceTypeAndAnyBICIdentifier1)
	return s.TypeAndIdentification
}

func (s *SafekeepingPlaceFormat11Choice) AddProprietary() *GenericIdentification85 {
