...
type ProcessingStatus37Choice struct {
	...
	Rejected *RejectionStatus13Choice `xml:"Rjctd"`
...
func (p *ProcessingStatus37Choice) AddAcknowledgedAccepted() *AcknowledgedAcceptedStatus7Choice {
	p.AcknowledgedAccepted = new(AcknowledgedAcceptedStatus7Choice)
	return p.AcknowledgedAccepted
}

func (p *ProcessingStatus37Choice) AddPendingProcessing() *PendingProcessingStatus3Choice {
	p.PendingProcessing = new(PendingProcessingStatus3Choice)
	return p.PendingProcessing
}

func (p *ProcessingStatus37Choice) AddRejected() *RejectionStatus13Choice {
	p.Rejected = new(RejectionStatus13Choice)
	return p.Rejected
}

func (p *ProcessingStatus37Choice) AddRepair() *RepairStatus5Choice {
	p.Repair = new(RepairStatus5Choice)
	return p.Repair
}

func (p *ProcessingStatus37Choice) AddCancelled() *CancellationStatus7Choice {
	p.Cancelled = new(CancellationStatus7Choice)
	return p.Cancelled
}

func (p *ProcessingStatus37Choice) AddPendingCancellation() *PendingStatus13Choice {
	p.PendingCancellation = new(PendingStatus13Choice)
	return p.PendingCancellation
}

func (p *ProcessingStatus37Choice) AddProprietary() *ProprietaryStatusAndReason1 {
	p.Proprietary = new(ProprietaryStatusAndReason1)
	return p.Proprietary
}

func (p *ProcessingStatus37Choice) AddCancellationRequested() *ProprietaryReason1 {
	p.CancellationRequested = new(ProprietaryReason1)
	return p.CancellationRequested
}

func (p *ProcessingStatus37Choice) AddModificationRequested() *ProprietaryReason1 {
