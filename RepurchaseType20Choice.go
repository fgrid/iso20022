...
type RepurchaseType20Choice struct {
...
func (r *RepurchaseType20Choice) SetCode(value string) {
	r.Code = (*RepurchaseType2Code)(&value)
}

func (r *RepurchaseType20Choice) AddProprietary() *GenericIdentification47 {
