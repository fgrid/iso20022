...
type AccountIdentification3Choice struct {
	...
	ProprietaryAccount *SimpleIdentificationInformation2 `xml:"PrtryAcct"`

}


func (a *AccountIdentification3Choice) SetIBAN(value string) {
	a.IBAN = (*IBANIdentifier)(&value)
}

func (a *AccountIdentification3Choice) SetBBAN(value string) {
	a.BBAN = (*BBANIdentifier)(&value)
}

func (a *AccountIdentification3Choice) SetUPIC(value string) {
	a.UPIC = (*UPICIdentifier)(&value)
}

func (a *AccountIdentification3Choice) AddProprietaryAccount() *SimpleIdentificationInformation2 {
	a.ProprietaryAccount = new(SimpleIdentificationInformation2)
	return a.ProprietaryAccount
}
