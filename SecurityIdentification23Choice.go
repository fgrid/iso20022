...
func (s *SecurityIdentification23Choice) SetSEDOL(value string) {
	s.SEDOL = (*SEDOLIdentifier)(&value)
}

func (s *SecurityIdentification23Choice) SetCUSIP(value string) {
	s.CUSIP = (*CUSIPIdentifier)(&value)
}

func (s *SecurityIdentification23Choice) SetRIC(value string) {
	s.RIC = (*RICIdentifier)(&value)
}

func (s *SecurityIdentification23Choice) SetTickerSymbol(value string) {
	s.TickerSymbol = (*TickerIdentifier)(&value)
}

func (s *SecurityIdentification23Choice) SetBloomberg(value string) {
	s.Bloomberg = (*BloombergIdentifier)(&value)
}

func (s *SecurityIdentification23Choice) SetCTA(value string) {
	s.CTA = (*ConsolidatedTapeAssociationIdentifier)(&value)
}

func (s *SecurityIdentification23Choice) SetQUICK(value string) {
	s.QUICK = (*QUICKIdentifier)(&value)
}

func (s *SecurityIdentification23Choice) SetWertpapier(value string) {
	s.Wertpapier = (*WertpapierIdentifier)(&value)
}

func (s *SecurityIdentification23Choice) SetDutch(value string) {
	s.Dutch = (*DutchIdentifier)(&value)
}

func (s *SecurityIdentification23Choice) SetValoren(value string) {
	s.Valoren = (*ValorenIdentifier)(&value)
}

func (s *SecurityIdentification23Choice) SetSicovam(value string) {
	s.Sicovam = (*SicovamIdentifier)(&value)
}

func (s *SecurityIdentification23Choice) SetBelgian(value string) {
	s.Belgian = (*BelgianIdentifier)(&value)
}

func (s *SecurityIdentification23Choice) SetCommon(value string) {
	s.Common = (*EuroclearClearstreamIdentifier)(&value)
}

func (s *SecurityIdentification23Choice) AddOtherProprietaryIdentification() *AlternateSecurityIdentification7 {
