...
type PaymentInstrument6Choice struct {
...
func (p *PaymentInstrument6Choice) AddPaymentCardDetails() *PaymentCard2 {
	p.PaymentCardDetails = new(PaymentCard2)
	return p.PaymentCardDetails
}

func (p *PaymentInstrument6Choice) AddCreditTransferDetails() *CreditTransfer3 {
	p.CreditTransferDetails = new(CreditTransfer3)
	return p.CreditTransferDetails
}

func (p *PaymentInstrument6Choice) AddDirectDebitDetails() *DirectDebitMandate2 {
	p.DirectDebitDetails = new(DirectDebitMandate2)
	return p.DirectDebitDetails
}

func (p *PaymentInstrument6Choice) AddChequeDetails() *Cheque3 {
	p.ChequeDetails = new(Cheque3)
	return p.ChequeDetails
}

func (p *PaymentInstrument6Choice) AddAccountDetails() *InvestmentAccount15 {
